...
<body>
	...
	function page(idx){
		var pagenum = idx;           
		location.href="${pageContext.request.contextPath}/Notice.do?pageNum="+pagenum+"&board=1";    
}
</script>
		...
		<div class="Content-container103">
			<div class="Header-container103">
				<h3 class="introduction103">
					<img src="images/title.PNG"> 고객상담실
				</h3>
			</div>
				...
				<div class="BoardList">
						...
						<tbody>
							<c:forEach var="list" items="${list }">
								<tr style="cursor: pointer"
									onclick="location.href='./NoticeInquiry.do?id=${list.getId() }'">
					...
					<div class="Make-Button102">
						<form action="./DrawUp.do">
							<input type="hidden" name="board" value="1"> <input
